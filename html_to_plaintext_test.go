...
func TestToPlaintextWithFragment(t *testing.T) {
	checkPremailerToPlaintext(t, `Test`, `<p>Test</p>`)
}

func TestToPlaintextWithBody(t *testing.T) {
	checkPremailerToPlaintext(t, `Test`, `<html>
...
func TestWrappingSpans(t *testing.T) {
	checkPremailerToPlaintext(t, `Test line 2`, `<html>
	    <body>
			<p><span>Test</span>
			<span>line 2</span>
			</p>`)
...
func TestStrippingIgnoredBlocks(t *testing.T) {
	checkPremailerToPlaintext(t, "test\n\ntext", `<p>test</p>
    <!-- start text/html -->
...
func TestWrappingLines(t *testing.T) {
	txt := premailer.ConvertToText(strings.Repeat("test ", 100), 20)
...
func TestWrappingLinesWithSpaces(t *testing.T) {
	...
	expect := "Long line\nnew line"
	if plain := premailer.ConvertToText(raw, 10); strings.TrimSpace(plain) != expect {
...
func TestMultipleLinksPerLine(t *testing.T) {
	...
	if plain := premailer.ConvertToText(html, 10000); strings.TrimSpace(plain) != expect {
